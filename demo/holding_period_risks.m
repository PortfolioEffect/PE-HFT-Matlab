...
util_plot2d(portfolio_VaR(highFrequencyPortfolioHoldOnly,0.95),'HF HoldOnly','Title','VaR, daily')+...
    util_line2d(portfolio_VaR(highFrequencyPortfolioAllDay,0.95),'HF AllDay')+...
    util_line2d(portfolio_VaR(lowFrequencyPortfolioHoldOnly,0.95),'LF HoldOnly')+...
    util_line2d(portfolio_VaR(lowFrequencyPortfolioAllDay,0.95),'LF AllDay')
