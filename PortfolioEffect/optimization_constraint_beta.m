...
% Usage
% 
% optimization_constraint_beta(optimizer,constraintType,constraintValue)
% 
% optimizer
...
function [optimizer] = optimization_constraint_beta(optimizer,constraintType,constraintValue)
