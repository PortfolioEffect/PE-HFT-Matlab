...
% util_plot2d(position_starrRatio(portfolioExample,'GOOG',0.05),'Position STARR Ratio GOOG')
% 
...
% util_plot2d(position_starrRatio(portfolioExample,'AAPL',0.05),'Position STARR Ratio AAPL')
