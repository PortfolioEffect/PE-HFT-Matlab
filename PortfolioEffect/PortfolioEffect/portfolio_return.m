...
% util_plot2d(portfolio_return(portfolioExample),'Portfolio Return ')
% 
...
% util_plot2d(portfolio_return(portfolioExample),'Portfolio Return ')
function [portfolio_return] = portfolio_return(portfolio)
     portfolio_return=position_metric(portfolio,'metric','PORTFOLIO_RETURN');
end
