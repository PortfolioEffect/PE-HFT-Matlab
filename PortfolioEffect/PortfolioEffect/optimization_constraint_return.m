...
% 
% Adds portfolio optimization constraint restricting optimal portfolio's return to a certain range.
% 
% Usage
% 
% optimization_constraint_return(optimizer,constraintType,constraintValue)
% 
% optimizer
...
% optimizer=optimization_constraint_return(optimizer,'>=',0);
% optimization_run(optimizer)
function [optimizer] =  optimization_constraint_return(optimizer,constraintType,constraintValue)
