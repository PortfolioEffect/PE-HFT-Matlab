...
% 
% Adds portfolio optimization constraint restricting optimal portfolio's CVaR to a certain range.
% 
% Usage
% 
% optimization_constraint_CVaR(optimizer,constraintType,constraintValue,confidenceInterval)
% 
% optimizer
