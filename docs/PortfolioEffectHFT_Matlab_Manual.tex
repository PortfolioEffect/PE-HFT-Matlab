...
\vspace{0.3cm}
{\Huge\bfseries PortfolioEffect HFT Toolbox \\ for MATLAB \\ }
% ----------------------------------------------------------------
\vspace{1.5cm}
...
PortfolioEffect HFT toolbox for MATLAB is provided as a zip archive for all
...
Download self-install executable for Windows from PortfolioEfect
\href{https://www.portfolioeffect.com/docs/platform/quant/downloads}{downloads}.
...
menu.
The PortfolioEffect HFT toolbox is now fully configured.
...
PortfolioEffect HFT Toolbox for MATLAB.
