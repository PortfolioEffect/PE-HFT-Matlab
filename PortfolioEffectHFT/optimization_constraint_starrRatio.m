...
% 
% Adds portfolio optimization constraint restricting optimal portfolio's STARR ratio to a certain range.
% 
% Usage
% 
% optimization_constraint_starrRatio(optimizer,constraintType,constraintValue,confidenceInterval)
% 
% optimizer
